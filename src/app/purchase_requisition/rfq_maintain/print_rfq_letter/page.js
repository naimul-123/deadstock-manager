...
const Project = ({ params }) => {
    ...
    return (
        <div className="min-h-[calc(100vh-44px)] grow">
            {projection &&
                <>
                    <div className="flex p-2  gap-2 justify-between items-center bg-slate-400 print:hidden  ">
                        ...
                        <div className="flex gap-2 justify-between items-center">
                            ...
                            <button className="btn bg-gradient-to-r hover:bg-gradient-to-l text-white from-purple-600 to-violet-500" onClick={() => window.print()}>PrintPreview</button>
                        </div>
                    </div>

                    <div className="w-[595px] h-[842px] bg-base-300 border font-[sutonnyOMJ] mx-auto p-10">
                        ...
                        <div>
                            ...
                            <div className="py-8">
                                ...
                                <p className="indent-6 leading-none text-justify">এ অফিসের জন্য {items} ক্রয়ের সিদ্ধান্ত গৃহীত হয়েছে। উক্ত মালামালগুলো সরবরাহের নিমিত্তে সংযুক্ত ছকে দর উল্লেখপূর্বক সীলমোহরকৃত খামে নির্বাহী পরিচালক, বাংলাদেশ ব্যাংক, বরিশাল বরাবর আগামী ০৮/০৮/২০২৪ তারিখের মধ্যে
                                ...
                                <ol className="ml-6 leading-none text-justify">
                                    ...
                                    <li>০৬. {`${projection.committeeChairmanInfo.name}, অতিরিক্ত পরিচালক, ${projection.committeeChairmanInfo.section} বিভাগ, বাংলাদেশ ব্যাংক, বরিশাল-এই ঠিকানায় নির্ধারিত বাক্সে আগামী ১২/০৮/২০২৪ তারিখ সকাল ১১.০০ টার মধ্যে দরপ্রস্তাব দাখিল করতে হবে।`}</li>
                    ...
                    {
                        projection?.vendors?.map((vendor) => <div key={vendor.vendor_id} className="w-[595px] h-[842px] bg-base-300 border font-[sutonnyOMJ] mx-auto p-14 my-1">
                            <div className="flex justify-between items-end">
                                <div className="w-20 h-20"><Image alt="logo" src={logo} /></div>
                                <div className="font-bold text-center ">
                                    <h2 className="text-3xl">বাংলাদেশ ব্যাংক</h2>
                            ...
                            <div>
                                <h2 className="font-semibold text-lg text-center underline leading-4 py-8">{projection.notingHeading}</h2>
                                <div className="">
                                    <p className="leading-none">জনাব,</p>
                                    <p className="indent-6 leading-none text-justify">এ অফিসের জন্য {items} ক্রয়ের সিদ্ধান্ত গৃহীত হয়েছে। উক্ত মালামালগুলো সরবরাহের নিমিত্তে সংযুক্ত ছকে দর উল্লেখপূর্বক সীলমোহরকৃত খামে নির্বাহী পরিচালক, বাংলাদেশ ব্যাংক, বরিশাল বরাবর আগামী ০৮/০৮/২০২৪ তারিখের মধ্যে
                                        তারিখ সকাল ১১.০০টার মধ্যে দরপ্রস্তাব দাখিল করার জন্য আপনাদেরকে অনুরোধ করা যাচ্ছে। <br></br>
